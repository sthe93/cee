$.fn.pageMe = function(opts){
   ...
   // var numItems = children.size();
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="prev_link" title="' + settings.prevText +'"><i class="material-icons"><i class="fa fa-chevron-left" aria-hidden="true"></i></i></a></li>').appendTo(pager);
    }
    ...
    if (settings.showPrevNext){
        $('<li><a href="#" class="next_link"  title="' + settings.nextText +'"><i class="material-icons"><i class="fa fa-chevron-right" aria-hidden="true"></i></i></a></li>').appendTo(pager);
    }
